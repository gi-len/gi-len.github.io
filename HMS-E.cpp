// HMS-E Records of Positive Patient on COVID-19
...
void getDoctor(){
	...
	cout<<"\n\n\n\nEnter 1 to return to Positive Patient Database\nEnter 2 to Back Main Menu."<<endl;
	int c;
	cin>>c;
	if(c==1){
	  system("cls");
...
void addPat(){
	patient p;										//ID,firstname,lastname,age,phnumber,occupation,city,disease,Adate,Rdate,bill,spec
		...
		cin>>p.p_city;
   		cout<<"Symptoms:"<<endl;
   		cin>>p.dis;
   		cout<<"Positive date  (DD/MM/YYYY):"<<endl;
   		cin>>p.addDate;
   		cout<<"Recover date  (DD/MM/YYYY):"<<endl;
   		cin>>p.relDate;	
	...
	cout<<"\n\t\tNew Postive Patient profile created successfully!"<<endl<<endl<<endl;
...
void editPat(patient &pat){
	int x;
	cout<<"\nEnter the ID of the Positive Patient whose profile you want to Edit:"<<endl;
	cin>>x;									 
	...
	{
		if(p_ID==x){
		cout<<"1.ID:"<<p_ID<<endl<<"2.First Name:"<<fname<<endl<<"3.Last Name:"<<lname<<endl<<"4.Age"<<p_age<<endl<<"5.Phone No.:"<<phnumber<<endl<<"6.Occupation:"<<occupation<<endl<<"7.City:"<<p_city<<endl<<"8.Symptoms:"<<dis<<endl<<"9.Positive date(DD/MM/YYYY):"<<addDate<<endl<<"10.Recover date(DD/MM/YYYY):"<<relDate<<endl<<"11.Total Bill generated:"<<bill<<endl<<"12.Kind of Specialization required:"<<dept<<endl;
		count++;
		break;
		}
	}
...
void displayPat(){
	int x;
	cout<<"\nEnter the ID of the Positive Patient whose profile you want to Display:"<<endl;
	cin>>x;									 
	fstream patObj("patient.txt");
	patObj.seekg(0);
													//ID,firstname,lastname,age,phnumber,occupation,city,disease,Adate,Rdate,bill,dept
...
cout<<"\n\nEnter 1 to return to Postive Patient Database\nEnter 2 to Back Main Menu."<<endl;
	int c;
	cin>>c;
	if(c==1){
	  system("cls");
...
{
int x;
	cout<<"\nEnter the ID of the Positive Patient whose profile you want to Delete:"<<endl;
	cin>>x;									 
	fstream patObj("patient.txt");
	patObj.seekg(0);
													//ID,firstname,lastname,age,phnumber,occupation,city,disease,Adate,Rdate,bill,dept
...
void dispPatDatabase(){
	...
	Obj.seekg(0);
	cout<<right<<setw(70)<<setfill(' ')<<"POSITIVE PATIENT DATABASE"<<endl<<endl;
	string fname,lname,occupation,p_city,dis,addDate,relDate,dept;
	int p_age,p_ID,count=0;
	long double phnumber,bill;
...
void numberofPats(){
	...
	Obj.close();
	cout<<"\n\n\tThe number of positive patients in the hospital="<<count<<endl;
...
//the getStatus function
 void getStatus()
 {	bed b;
  cout<<"\n\tTotal Number of Beds for Positive Patients in the Hospital: "<<b.total<<endl;
  fstream file("patient.txt");
  	file.seekg(0);
	string fname,lname,occupation,p_city,dis,addDate,relDate,dept;
	int p_age,p_ID,count=0;
	...
	file.close();
	cout<<"\n\tThe number of Occupied Beds for Positive Patients= "<<count<<endl;
	cout<<"\n\tThe number of Empty Beds for Positive Patients= "<<b.total-count<<endl;
...
int main(){
	...
	cout<<endl;
	cout<<right<<setw(60)<<setfill(' ')<<"WELCOME TO HOSPITAL MANAGEMENT SYSTEM E - RECORDS OF POSTIVE PATIENTS ON COVID 19  "<<endl;
	cout<<endl<<endl;
...
int chooseMain(){
	...
	cout<<"			"<<"2.Enter Into Positive Patients' Database"<<endl;
...
void	getPatientDatabase(){
	int choice_pat;
	cout<<"\n                         "<<"WELCOME TO POSITIVE PATIENT'S DATABASE"<<endl<<endl;
...
void getBedDatabase(){
int choice_bed;
	cout<<"\n                         "<<"WELCOME TO POSITIVE PATIENTS BED DATABASE"<<endl<<endl;
